...
import transformGroups.CopyOfBoxGroup;
...
public class CopyOfSlideShowPanel extends Applet implements MouseListener,CASE_VÅR_2010_Interface {
	protected File images;
	  protected Alpha alpha;
	  protected TransformGroup scaleTransGroup;
	  protected SphereGroup sphereGroup;
	  protected CopyOfBoxGroup boxGroup;
	...
	public static void main(String[] args) {
	    ...
	    new GUI_Case(new CopyOfSlideShowPanel(), 640, 480);
	  }
	...
	private BranchGroup createSceneGraph() {
		...
		boxGroup = new CopyOfBoxGroup(slideTime, bounds, textures, lightPos, wallPos, 0);

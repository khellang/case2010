...
public class CopyOfBoxGroup extends TransformGroup {
	...
	public CopyOfBoxGroup(int slideTime, BoundingSphere bounds, TextureList textures, Point3f lightPos, Point3f wallPos, int delay) {
